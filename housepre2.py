...
# load the dataset
dataframe = read_csv('pre.csv', usecols=[1], engine='python')
...
#31022
#32029
print(trainX[trainX.shape[0]-1])
print(testX[testX.shape[0]-1])
"""
# reshape input to be [samples, time steps, features]
trainX = numpy.reshape(trainX, (trainX.shape[0], 1, trainX.shape[1]))
testX = numpy.reshape(testX, (testX.shape[0], 1, testX.shape[1]))

#激活函数为 sigmoid 或者 tanh 时，要把数据正则话，此时 LSTM 比较敏感
